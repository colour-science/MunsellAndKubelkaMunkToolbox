...
% $Id: optproc.m 23 2007-01-28 22:55:34Z jerkerw $
	...
	% Following lines reformatted by PMC on Nov. 20, 2013, to work in Octave
	% 0         1          2         3         4             5             6            7 
	varcell = {'ANY'     'CWF'      'ILL'     'OBS'     'RGBTYPE'     'WLRANGE'     'NUM'        'RGBCLASS'};
	funcell = {@NullCheck, @CheckCWF, @CheckIll, @CheckObs, @CheckRGBType, @CheckWLRange, @CheckNumeric, @CheckRGBClass};
	check=struct(...   
			  'var', varcell, ...
			  'fun', funcell );
...
% Following line commented out by PMC on Nov. 20, 2013
...
% Following conditional commented out by PMC on Nov. 20, 2013, becuase it produced an error in Octave
%	if nd(1)<0
