...
% First two arguments (cwf and lam) added by Paul Centore on November 29, 2013, because Octave is automatically
% coercing the internal function getcwf into a subfunction.
	function z=getcwf(cwf, lam, name, varargin)
		z=[];
		if nargin==0
			z=cwf;
		else
